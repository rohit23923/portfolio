...
// import {Link as open} from 'react-router-dom'
// const Work = () => {
//     return (
...
//                             <Link to=''><button className='text-center rounded-lg px-4 py-3 m-2 bg-white text-gray-700 font-bold text-lg hover:bg-zinc-800 hover:text-white'>Click to See</button></Link>
//                             </div>
//                         </div>
//                     </div>
...
//                             </span>
//                             <div className='pt-8 text-center'>
//                             <open to='https://weather-application-eosin-two.vercel.app/'><button className='text-center rounded-lg px-4 py-3 m-2 bg-white text-gray-700 font-bold text-lg hover:bg-zinc-800 hover:text-white'>Click to See</button></open>
//                             </div>
//                         </div>
//                     </div>
